...
public class Thuattoancattia {
    ...
    public ViTri minimax(int player, ViTri viTri, int depth) {
        ...
        System.out.println("Minimax - 실행 시간 : " + executionTime + " milliseconds");
        System.out.println("Minimax 알고리즘에서 검토한 노드 수 : " + nodeCount);

        // In bộ nhớ sử dụng
        Runtime runtime = Runtime.getRuntime();
        long usedMemory = runtime.totalMemory() - runtime.freeMemory();
        System.out.println("Minimax 알고리즘에서 사용된 메모리 (MB) : " + usedMemory / (1024 * 1024));
        return viTriTotNhat;
    }
    ...
    public ViTri alphaBeta(int player, ViTri viTri, int alpha, int beta, int depth) {
        ...
        System.out.println("Alpha-Beta 알고리즘의 실행 시간 : " + executionTime + " milliseconds");
        System.out.println("Alpha-Beta 알고리즘에서 검토한 노드 수 : " + nodeCount);

        // In bộ nhớ sử dụng
        Runtime runtime = Runtime.getRuntime();
        long usedMemory = runtime.totalMemory() - runtime.freeMemory();
        System.out.println("Alpha-Beta 알고리즘에서 사용된 메모리 (MB) : " + usedMemory / (1024 * 1024));
        return viTriTotNhat;
    }
}
